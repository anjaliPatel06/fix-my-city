...
function AdminDashboardPage() {
    _s();
    const { user, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [draftStatuses, setDraftStatuses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const [isFetchingComplaints, setIsFetchingComplaints] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [updatingTicketId, setUpdatingTicketId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboardPage.useEffect": ()=>{
            ...
            const loadComplaints = {
                "AdminDashboardPage.useEffect.loadComplaints": async ()=>{
                    ...
                    try {
                        ...
                        const visibleReports = user.department ? reports.filter({
                            "AdminDashboardPage.useEffect.loadComplaints": (report)=>report.assignedDepartment === user.department
                        }["AdminDashboardPage.useEffect.loadComplaints"]) : reports;
                        setComplaints(visibleReports);
                        setDraftStatuses(Object.fromEntries(visibleReports.map({
                            "AdminDashboardPage.useEffect.loadComplaints": (report)=>[
                                    report.ticketId,
                                    report.status
                                ]
                        }["AdminDashboardPage.useEffect.loadComplaints"])));
                    } catch (err) {
                        if (!active) return;
                        setComplaints([]);
                        setDraftStatuses({});
    ...
    const cities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboardPage.useMemo[cities]": ()=>Array.from(new Set(complaints.map({
                "AdminDashboardPage.useMemo[cities]": (complaint)=>complaint.city
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboardPage.useMemo[stats]": ()=>{
            ...
            const submitted = complaints.filter({
                "AdminDashboardPage.useMemo[stats]": (complaint)=>complaint.status === "Submitted"
            }["AdminDashboardPage.useMemo[stats]"]).length;
            const assigned = complaints.filter({
                "AdminDashboardPage.useMemo[stats]": (complaint)=>complaint.status === "Assigned"
            }["AdminDashboardPage.useMemo[stats]"]).length;
            const inProgress = complaints.filter({
                "AdminDashboardPage.useMemo[stats]": (complaint)=>complaint.status === "In Progress"
            }["AdminDashboardPage.useMemo[stats]"]).length;
            const resolved = complaints.filter({
                "AdminDashboardPage.useMemo[stats]": (complaint)=>complaint.status === "Resolved"
            }["AdminDashboardPage.useMemo[stats]"]).length;
            return {
                total,
                submitted,
    ...
    const filteredComplaints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboardPage.useMemo[filteredComplaints]": ()=>{
            return complaints.filter({
                "AdminDashboardPage.useMemo[filteredComplaints]": (complaint)=>{
    ...
    const recentComplaints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboardPage.useMemo[recentComplaints]": ()=>complaints.slice(0, 3)
    }["AdminDashboardPage.useMemo[recentComplaints]"], [
        complaints
    ]);
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                        children: [
                                                            ...
                                                            filteredComplaints.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                cities.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs text-slate-500 dark:text-slate-400",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                            ...
                                            children: [
                                                ...
                                                recentComplaints.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                    className: "text-slate-500 dark:text-slate-400",
...
_s(AdminDashboardPage, "HEDRAvUdrmDVSfMOLn4jDD8RvSA=", false, function() {
    return [
...
//# sourceMappingURL=_c33ba039._.js.map