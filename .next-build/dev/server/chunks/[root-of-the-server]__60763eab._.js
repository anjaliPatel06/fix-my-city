...
"[project]/lib/server/whatsapp.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isWhatsAppConfigured() {
    return Boolean(getBusinessNumber() && process.env.WHATSAPP_PHONE_NUMBER_ID?.trim() && process.env.WHATSAPP_ACCESS_TOKEN?.trim() && process.env.WHATSAPP_VERIFY_TOKEN?.trim());
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/server/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/server/whatsapp.ts [app-route] (ecmascript)");
;
;
;
async function POST(req) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isWhatsAppConfigured"])()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createWhatsAppComplaintSession"])({
            userEmail,
            userName
        });
        const launchLink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildWhatsAppLaunchLink"])(session.token);
        if (!launchLink) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60763eab._.js.map