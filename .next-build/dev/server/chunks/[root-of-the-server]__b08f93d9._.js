...
async function GET(req) {
    const verification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2f$webhook$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyWhatsAppWebhookChallenge"])(req);
    if (verification.ok) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](verification.challenge, {
            status: 200
        });
    }
...
async function POST(req) {
    ...
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2f$webhook$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyMetaWebhookSignature"])(rawBody, signature)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const inboundMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2f$webhook$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseInboundWhatsAppMessages"])(payload);
        for (const message of inboundMessages){
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2f$processor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processIncomingWhatsAppMessage"])(message);
            } catch (error) {
                console.error("whatsapp webhook message error:", error);
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$whatsapp$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendWhatsAppTextMessage"])(message.from, "Maaf kijiye, complaint process karte waqt issue aa gaya. Kripya dobara koshish karein.");
                } catch (replyError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b08f93d9._.js.map