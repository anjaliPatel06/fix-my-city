    ...
    try {
        ...
        if (body?.action === "toggle-upvote") {
            ...
            if (!actorId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: "User identifier is required to like this issue."
                }, {
                    status: 400
                });
            }
            const { complaint: report, liked } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$reports$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toggleComplaintUpvote"])({
        ...
        if (body?.action === "add-comment") {
            ...
            if (!authorId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: "User identifier is required to comment."
                }, {
                    status: 400
                });
            }
            ...
            const { complaint: report, comment } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$reports$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addComplaintComment"])({
                ticketId: normalizedTicketId,
                authorId,
                authorName,
                body: commentBody
