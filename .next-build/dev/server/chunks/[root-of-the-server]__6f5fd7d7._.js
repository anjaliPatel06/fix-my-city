...
Use the complaint text, existing fields, and image together to extract the best final details.`;
        ...
        const mergedData = {
            category: normalizeExtractedValue(parsed?.category, "Unknown") !== "Unknown" ? normalizeExtractedValue(parsed?.category, "Unknown") : normalizeExtractedValue(existingFields?.category, "Unknown"),
            description: normalizeExtractedValue(parsed?.description) !== "Extracting..." ? normalizeExtractedValue(parsed?.description) : normalizeExtractedValue(description || existingFields?.description),
            urgency: normalizeUrgency(parsed?.urgency || existingFields?.urgency),
            address: normalizeExtractedValue(parsed?.address) !== "Extracting..." ? normalizeExtractedValue(parsed?.address) : normalizeExtractedValue(existingFields?.address),
            city: normalizeExtractedValue(parsed?.city) !== "Extracting..." ? normalizeExtractedValue(parsed?.city) : normalizeExtractedValue(existingFields?.city),
            pincode: normalizeExtractedValue(parsed?.pincode) !== "Extracting..." ? normalizeExtractedValue(parsed?.pincode) : normalizeExtractedValue(existingFields?.pincode)
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f5fd7d7._.js.map